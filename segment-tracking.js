 ...
 *
 * Loads Segment (analytics.js) itself — `integrations.segment` is intentionally
 * removed from docs.json so Mintlify never emits its built-in `docs.*` events
 * (docs.content.view, docs.navitem.click, …). Only the custom events below
 * are sent to Segment.
 *
...
(function () {
  ...
  // Intentionally NOT calling analytics.page() — our page_event covers views.
})();
