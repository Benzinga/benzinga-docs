...
> [!TIP]
> **Mejor práctica**: Verifica siempre primero el **código de estado HTTP** para determinar si una solicitud fue exitosa. No confíes únicamente en el cuerpo de la respuesta, ya que el formato puede variar entre diferentes endpoints de la API.
