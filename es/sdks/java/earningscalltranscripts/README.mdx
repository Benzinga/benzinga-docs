---
title: "Transcripciones de conferencias de resultados"
description: earningsCallTranscripts()
---

[&lt; ATRÁS](/es/sdks/languages/java#earningscalltranscripts)
...
* [get](#get) - Obtener transcripciones de conferencias de resultados
* [getAudio](#getaudio) - Obtener archivos de audio de las transcripciones de conferencias de resultados

<div id="get">
  ## get
</div>

Obtener transcripciones de llamadas de resultados
...
| ------------------ | ------------------ | ------------------ | ------------------ |
| `tickers`          | List&lt;*String*&gt;    | :heavy&#95;minus&#95;sign: | Símbolos bursátiles|
...
Obtener archivos de audio de las transcripciones de conferencias de resultados
