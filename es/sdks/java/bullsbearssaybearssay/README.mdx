...
* [get](#get) - Obtener Bulls Say Bears Say V1

<div id="get">
  ## get
</div>

Obtener Bulls Say Bears Say V1
...
| ------------------- | ------------------- | ------------------- | ------------------- |
| `symbols`           | *Optional&lt;String&gt;* | :heavy&#95;minus&#95;sign:  | Símbolos (lista de símbolos separados por comas) |
