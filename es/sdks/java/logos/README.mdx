...
* [bulkSync](#bulksync) - Obtener logotipos para las claves de búsqueda proporcionadas
* [search](#search) - Obtener logotipos para las claves de búsqueda proporcionadas

<div id="bulksync">
  ## bulkSync
</div>

Obtener Logos para las claves de búsqueda especificadas
...
| --------------------------------------------------------------------- | --------------------------------------------------------------------- | --------------------------------------------------------------------- | --------------------------------------------------------------------- |
| `request`                                                             | [LogoBulkSyncRequest](../../models/operations/LogoBulkSyncRequest.md) | :heavy&#95;check&#95;mark:                                                    | El objeto de solicitud que se utilizará.                              |
...
Obtener logotipos para las claves de búsqueda proporcionadas
