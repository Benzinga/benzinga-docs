...
[&lt; VOLVER](/es/sdks/languages/java#ratingsanalysts)
...
* [get](#get) - Obtener calificaciones de analistas

<div id="get">
  ## get
</div>

Devuelve la lista completa de analistas que proporcionan calificaciones
...
| --------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- | --------------------------------------------------------------------------------- |
| `request`                                                                         | [GetRatingsAnalystsRequest](../../models/operations/GetRatingsAnalystsRequest.md) | :heavy&#95;check&#95;mark:                                                                | El objeto de solicitud que se utilizará para la operación.                        |
