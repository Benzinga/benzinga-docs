...
<Steps>
  ...
  <Step title="Pruebe su integración">
    Use el endpoint [Test Webhook Delivery](/es/api-reference/webhook_api/test-webhook-delivery) para verificar que su endpoint de webhook esté correctamente configurado y pueda recibir entregas.
  </Step>
