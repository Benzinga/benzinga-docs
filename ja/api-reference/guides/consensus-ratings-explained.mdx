...
<CardGroup cols={2}>
  <Card title="Consensus Ratings API" icon="chart-bar" href="/ja/api-reference/calendar-api/consensus_ratings/returns-analyst-ratings-consensus-data">
    株式のコンセンサスレーティングデータを取得します
  </Card>

  <Card title="Analyst Ratings API" icon="users" href="/ja/api-reference/calendar-api/ratings/returns-analyst-ratings-data">
