---
title: "FDA"
openapi: /ja/openapi/calendar_api.spec.yml GET /api/v2.1/calendar/fda
---
  ...
  "fda": [
    {
      ...
      "nic_number": "",
      "notes": "",
      "outcome": "Alpha Tau Medical Ltd.は、米国食品医薬品局（FDA）が同社に対して、より柔軟なモジュラー方式の使用を認めるという以前の決定を受けて、市販前承認（PMA）申請の第1モジュールをFDAに提出したと発表しました。",
      "outcome_brief": "",
